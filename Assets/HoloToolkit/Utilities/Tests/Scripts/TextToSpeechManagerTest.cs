...
public class TextToSpeechManagerTest : MonoBehaviour
{
    ...
    private void GestureRecognizer_TappedEvent(InteractionSourceKind source, int tapCount, Ray headRay)
    {
        ...
        if (gm.IsGazingAtObject)
        {
            ...
            // If we have a text to speech Service on the target object, say something.
    ...
    {
        // Say something using the text to speech Service on THIS test class (the "global" one).

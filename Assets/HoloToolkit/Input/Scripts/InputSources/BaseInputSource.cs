...
{ 
    ...
    public abstract class BaseInputSource : MonoBehaviour, IInputSource
    {
        ...
        /// <summary>
        /// Enables the input source so that the input Service can use it.
        /// </summary>
        ...
        /// <summary>
        /// Disables the input source so that the input Service stops using it.
        /// </summary>
        ...
        /// <summary>
        /// Register this input source with the input Service.
        /// </summary>
        ...
        /// <summary>
        /// Unregister this input source from the input Service.
        /// </summary>

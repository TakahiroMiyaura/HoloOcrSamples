...
public class ImportExportAnchorManager : Singleton<ImportExportAnchorManager>
{
    ...
    /// <summary>
    /// The room Service API for the sharing service.
    /// </summary>
    ...
    private void Start()
    {
        //Wait for a notification that the sharing Service has been initialized (connected to sever)
    ...
    {
        // Setup the room Service callbacks.

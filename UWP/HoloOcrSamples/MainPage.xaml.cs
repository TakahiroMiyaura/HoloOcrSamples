...
namespace HoloOcrSamples
{
    ...
    {
        private readonly WinRTBridge.WinRTBridge _bridge;
        ...
        public MainPage()
        {
            ...
            var appCallbacks = AppCallbacks.Instance;

            // Setup scripting bridge
            _bridge = new WinRTBridge.WinRTBridge();
            appCallbacks.SetBridge(_bridge);

            var isWindowsHolographic = false;
            ...
            else
            {
                ...
                splash = ((App) Application.Current).splashScreen;
                GetSplashBackgroundColor();
                OnResize();
                onResizeHandler = (o, e) => OnResize();
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            await OcrService.InitializeOcrServiceAsync(SetMediaCapture);
        }


        public async Task SetMediaCapture(MediaCapture capture)
        {
            //Set MediaCapture to CaptureElement.
        ...
        private async void GetSplashBackgroundColor()
        {
            try
            {
                var file = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///AppxManifest.xml"));
                var manifest = await FileIO.ReadTextAsync(file);
                var idx = manifest.IndexOf("SplashScreen");
                ...
                if (manifest.Equals("transparent"))
                    ...
                    return;
                        // at this point the value is 'red', 'blue' or similar, Unity does not set such, so it's up to user to fix here as well
                var r = (byte) (value >> 16);
                ...
                {
                    var a = (byte) (transparent ? 0x00 : 0xFF);
        ...
        {
            return new XamlPageAutomationPeer(this);
        }
#else
